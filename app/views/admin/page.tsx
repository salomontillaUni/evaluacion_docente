...
export default function AdminView() {
  ...
  const handleExport = () => {
    toast.success("Reporte generado exitosamente", {
      description:
        "El archivo reporte_evaluaciones_2026.xlsx se ha descargado.",
    });
  };
  ...
  const metricas = [
    {
      ...
      value: metricasAdmin.totalEvaluaciones.toLocaleString(),
      icon: FileBarChart2,
    ...
    },
    {
      ...
      value: metricasAdmin.docentesEvaluados.toString(),
      icon: Users,
    ...
    },
    {
      ...
      value: `${metricasAdmin.promedioGeneral}/5.0`,
      icon: TrendingUp,
    ...
    },
    {
      ...
      value: `${metricasAdmin.tasaParticipacion}%`,
      icon: BarChart3,
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Dashboard de métricas y gestión de períodos
            </p>
          </div>
        </div>
        <button
        ...
        {metricas.map((m, i) => (
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div
                className={`w-9 h-9 rounded-lg ${m.color} flex items-center justify-center`}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-6">
            Evolución mensual de sentimientos estudiantiles
          </p>
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-6">
            Porcentaje de sentimientos en todas las evaluaciones
          </p>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart
      ...
      {/* Gestionar Período de Evaluación */}
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
          ...
          <p className="text-sm text-purple-100 mt-1">
            Configure fechas y asigne docentes al período
          </p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              >
                {docentesSeleccionados.length === docentes.length
                  ? "Deseleccionar todos"
                  : "Seleccionar todos"}
              </button>
            </div>
            ...
            {docentesSeleccionados.length > 0 && (
              <p className="mt-2 text-xs text-muted-foreground flex items-center gap-1">
                ...
                {docentesSeleccionados.length} de {docentes.length} docentes
                seleccionados
              </p>
            )}
          </div>
